...
<div class = "modal-body">
		...
		<br>
		<div class = "col-md-12">
		<a href="<?php echo site_url('Facebook_ion_auth/login'); ?>"><img class = "img-responsive" src="<?php echo site_url('/assets/img/logo/facebooksignup.png');?>" alt="Facebook sign up"></a>
		</div>
		<div class = "col-md-12">
