<? if (isset($sticky_venues) && !empty($sticky_venues)): ?>

    <? foreach ($sticky_venues as $sticky_venue): ?>
        <a href="#" class="list-group-item venue" data-venue_id="<?= $sticky_venue->id ?>">
            <span class="badge"><?= $sticky_venue->events_count ?></span>
            <h4 class="list-group-item-heading venue-name"><?= $sticky_venue->venue_name ?></h4>

            <p class="list-group-item-text venue-address"><?= $sticky_venue->venue_address ?></p>
        </a>
    <? endforeach ?>
