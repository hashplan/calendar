	...
	<div class="row">
		<div class = "col-md-12 jumbotron-about" style="background-color:#f5f5f5; margin-bottom: 250px">
			<h3>Hashplan, a New York City-based technology startup, is innovating the way that people search, schedule, and share events with friends.
				...
				<br>
			<h3>Hashplan is truly a social network - a network built on the plans you make with your friends.
				With literally thousands of events going on in your area, don&#39t waste time tracking them manually!
				Use Hashplan to save time and make more plans with the people you enjoy being around.
			</h3>
		</div>
	</div>
</div>