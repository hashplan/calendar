...
<head>
    ...
    <meta name="keywords"
          content="Events, social, calendar, plan, share, enjoy, music, sports, broadway, to do, comedy">
    <meta name="description"
          content="Hashplan is a social application empowering users to search for events in their local community, schedule them on their plans and share with friends.">
    ...
    <!--	<link href="-->
    <?php //echo site_url('assets/css/css/smoothness/jquery-ui-1.10.4.custom.min.css');?><!--" rel="stylesheet">-->
