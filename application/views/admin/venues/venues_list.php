    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table class="table table-striped is_sortable_table" data-url="<?= site_url('admin/venues/venues_list') ?>"
                   ...
                   data-search="true" data-query-params="venue.requestParams">
                <thead>
                    <tr>
                        ...
                        <th class="col-md-2" data-field="venue_is_excluded" data-formatter="venue.isExcludedFormatter" data-sortable="true">Is Excluded</th>
                        <th class="col-md-1" data-field="venue_is_sticky" data-formatter="venue.isStickyFormatter" data-sortable="true">Is Sticky</th>
                        <th class="col-md-1" data-field="actions" data-formatter="venue.actionFormatter">Actions</th>
                    </tr>
                </thead>
                <tbody>
