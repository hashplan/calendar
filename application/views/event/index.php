    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <div class="modal-title"
                 id="myModalLabel"><?= html_escape(date('l, F d', strtotime($event->event_datetime))) ?></div>
            ...
            <span class="label label-success is-favourite is-favourite-<?= $is_favourite ? 'shown' : 'hidden' ?>">In favourites</span>
        </div>
        ...
        <div class="modal-footer">
            ...
            <? endif ?>
            <button type="button" class="btn btn-default button-close" data-dismiss="modal" aria-hidden="true">Close
            </button>
        </div>
    </div>
</div>
